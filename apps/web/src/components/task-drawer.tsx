...
export function TaskDrawer({ taskId, users, priorities, statuses, features, tags, onClose, onChanged, onNeedsReload }: {
  ...
  if (!data) return <div className="notion-overlay" style={overlay} onClick={onClose}><div style={{ color: "#fff" }}>กำลังโหลด...</div></div>;
  const t = data.task;
  ...
  return (
    <div className="notion-overlay" style={overlay} onClick={onClose}>
