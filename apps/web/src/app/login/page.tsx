  ...
  return (
    <div style={{ minHeight: "100dvh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg,#001D58,#0A2E7A)", padding: 20 }}>
      <div className="card" style={{ width: "min(420px,94vw)", padding: 32 }}>
        ...
        {tab === "google" ? (
          <a href="/api/auth/google" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, height: 48, borderRadius: 10, border: "1px solid #E5E7EB", textDecoration: "none", color: "#374151", fontWeight: 600, fontSize: 14, background: "#fff", transition: "box-shadow .15s, border-color .15s" }} onMouseEnter={(e) => { e.currentTarget.style.boxShadow = "0 1px 6px rgba(0,0,0,.12)"; e.currentTarget.style.borderColor = "#D1D5DB"; }} onMouseLeave={(e) => { e.currentTarget.style.boxShadow = "none"; e.currentTarget.style.borderColor = "#E5E7EB"; }}>
