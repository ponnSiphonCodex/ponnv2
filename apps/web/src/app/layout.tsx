...
import "./globals.css";
import { ApiTelemetry } from "@/components/api-telemetry";
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (<html lang="th" className={sarabun.variable}><body><ApiTelemetry />{children}<RouteLoadingOverlay /></body></html>);
}
