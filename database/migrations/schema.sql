...
-- ===== Seed: system_roles (Admin=GLOBAL เห็นทุกเมนู) =====
INSERT OR IGNORE INTO system_roles (id, role_name, module) VALUES
  (1, 'Admin', 'GLOBAL'),
  (2, 'PMO', 'PM'),
  (3, 'PM', 'PM'),
  (4, 'Member', 'PM');
...
-- ===== Seed: users =====
-- admin@ponnsth.com / Ponnsth@2026
...
-- ===== Seed: assign roles =====
-- ponnsiphon@gmail.com → Admin(1) + PMO(2)  |  admin@ponnsth.com → Admin(1)
INSERT OR IGNORE INTO user_roles (user_id, role_id)
  SELECT id, 1 FROM users WHERE email='ponnsiphon@gmail.com';
INSERT OR IGNORE INTO user_roles (user_id, role_id)
  SELECT id, 2 FROM users WHERE email='ponnsiphon@gmail.com';
INSERT OR IGNORE INTO user_roles (user_id, role_id)
  SELECT id, 1 FROM users WHERE email='admin@ponnsth.com';
...
INSERT OR IGNORE INTO workflow_statuses (id, project_id, name, category, sort_order) VALUES (1,1,'To Do','todo',1),(2,1,'Doing','doing',2),(3,1,'Done','done',3);
