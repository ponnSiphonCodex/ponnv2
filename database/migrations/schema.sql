...
CREATE TABLE meetings ( id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT NOT NULL, meeting_date INTEGER, start_time TEXT, organizer TEXT, attendees TEXT, project_name TEXT, minutes_longtext TEXT, internal_notes TEXT, created_at INTEGER NOT NULL DEFAULT (unixepoch()), updated_at INTEGER NOT NULL DEFAULT (unixepoch()), created_by TEXT, updated_by TEXT );
